// <copyright file="MultiOriginFlightSearchRequestValidator.cs" company="PlaceholderCompany">
...
namespace Web.Api.Validators
{
    ...
    /// <summary>
    /// Validator for MultiOriginFlightSearchRequest.
    /// </summary>
    public class MultiOriginFlightSearchRequestValidator : AbstractValidator<MultiOriginFlightSearchRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiOriginFlightSearchRequestValidator"/> class.
        /// </summary>
        public MultiOriginFlightSearchRequestValidator()
        {
            RuleFor(x => x.Origins)
